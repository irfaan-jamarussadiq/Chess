...
public class ShortCastlingMoveStrategy implements MoveStrategy {
	...
	public ShortCastlingMoveStrategy(BoardModel board) {
		this.board = board;
	}
	...
	public boolean isValidMove(Move move) {
		...
		return move.startRank() == startingRank && move.endFile() == 7
				&& board.pieceAt(startingRank, 6) == null
				&& board.pieceAt(startingRank, 7) == null;
	}
